...
class FrameSaver:
    ...
    def save(self, out_path, frame):
        ...
        try:
            ...
            print(" Save queue full — dropping a frame to keep capture real-time.")
...
def precreate_pattern_dirs(trial_folder: str, patterns):
    ...
    for pattern in patterns:
        ...
        try:
            ...
            dbg(f" couldn't create .keep in {frames_dir}: {e}")
        ...
        while not stop_event.is_set():
            ...
            if recording_flag.value:
                ...
                if not first_written:
                    ...
                    dbg(f" video_start_ns set to {video_start_ns.value}")
                    first_written = True
                ...
                if pending_state is None and ((shared_pat != effective_pattern) or (shared_fix != effective_fix_idx)):
                    ...
                    dbg(f"  pending_state={pending_state} will apply at frame {apply_at_idx}")
...
if __name__ == "__main__":
    ...
    if cam_proc.is_alive():
        print(" Camera process is still alive. Terminating forcefully.")
        cam_proc.terminate()
        cam_proc.join()
